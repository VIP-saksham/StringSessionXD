...
» ɴᴏ ᴀᴘɪ? ꜱᴋɪᴘ ᴋʟɪᴄᴋ ᴋʀᴏ — ʙᴏᴛ ᴀᴘɪ ᴜꜱᴇ ʜᴏɢᴀ 👇"""

ASK_API_HASH = """✅ ᴀᴘɪ_ɪᴅ ꜱᴀᴠᴇᴅ!

❖ ɴᴏᴡ ꜱᴇɴᴅ ʏᴏᴜʀ <b>ᴀᴘɪ_ʜᴀꜱʜ</b> ᴛᴏ ᴘʀᴏᴄᴇᴇᴅ.

» ɴᴏ ᴀᴘɪ? ꜱᴋɪᴘ ᴋʟɪᴄᴋ ᴋʀᴏ 👇"""


skip_buttons = lambda: InlineKeyboardMarkup(
    [[InlineKeyboardButton("⏭️ ꜱᴋɪᴘ — ʙᴏᴛ ᴀᴘɪ ᴜꜱᴇ ᴋʀᴏ", callback_data="skip", style="bg_primary")]]
)
